...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("ChessStone")
        self.setWindowIcon(QIcon('./assets/icons/chesslogo.png'))
    ...
    def closeEvent(self, event):
        if self.user:
            ...
            if self.stack.currentIndex() == 1 and not self.game_frame.board.saved:
                ...
                save_prompt.setWindowIcon(QIcon('./assets/icons/ChessLogo.png'))
                save_prompt.setIcon(QMessageBox.Warning)
                save_prompt.setWindowTitle("ChessStone")
