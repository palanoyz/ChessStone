...
class MoveFrame(QScrollArea):
    def __init__(self, board):
        ...
        self.setStyleSheet('background-color: #ffe5c7')
    ...
    def update_moves(self):
        ...
        for index, move in enumerate(move_history + undone_moves):
            ...
            if index % 2 == 0:
                ...
                move_num_label.setStyleSheet('font-size: 18px;' 'color: black')
            ...
            move_label.setStyleSheet('font-size: 18px;' 'color: black')
            ...
            if index == current_move_index:
                move_label.setStyleSheet('font-size: 18px;' 'background-color: yellow;'
                                         'color: black')
