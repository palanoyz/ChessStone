...
class ProfileFrame(QFrame):
    def __init__(self, parent):
        ...
        stylesheet = """
        ProfileFrame {
        background-image: url('./assets/backgrounds/2.png'); 
        ...
        back_widget.setFixedHeight(60)
        back_layout.addStretch(6)
        back_widget.setLayout(back_layout)

        labels_widget = QWidget()
        labels_layout = QVBoxLayout()
        labels_widget.setFixedHeight(300)
        labels_widget.setFixedWidth(600)
        ...
        self.figure.patch.set_facecolor('#E6912C')
        
        stats_widget = QWidget()
        stats_layout = QHBoxLayout()
        stats_widget.setFixedWidth(1400)
        stats_layout.addWidget(labels_widget, 3)
        stats_layout.addWidget(self.canvas, 7)
        stats_widget.setLayout(stats_layout)
        stats_widget.setFixedHeight(600)
