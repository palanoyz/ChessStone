...
from PyQt5.QtWidgets import QCheckBox, QDialog, QFrame, QHBoxLayout, QSlider, QStackedWidget, QVBoxLayout, QWidget, QVBoxLayout, QLabel
...
class MenuFrame(QFrame):
    def __init__(self, parent):
        ...
        # self.background_image = QPixmap('./assets/backgrounds/1.jpg')
    ...
    #     painter.drawPixmap(0, 0, self.background_image.scaled(self.size()))  # Draw the background image
    ...
    def open_dialog(self, load_game=False):
        ...
        menu = QDialog()
        menu.setWindowIcon(QIcon('./assets/icons/ChessLogo.png'))
        menu.setWindowTitle("ChessStone")
