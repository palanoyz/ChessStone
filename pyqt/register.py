...
class RegisterFrame(QFrame):
    def __init__(self, parent):
        ...
        username_stylesheet = "font-size: 20px;" 
        self.username_box.setStyleSheet(username_stylesheet)
        ...
        password_stylesheet = "font-size: 20px;" 
        self.password_box.setStyleSheet(password_stylesheet)
        ...
        confirm_password_stylesheet = "font-size: 20px;" 
        self.confirm_password_box.setStyleSheet(confirm_password_stylesheet)
    ...
    def register(self):
        ...
        if not username:
            ...
            username_error_stylesheet = "font-size: 20px; color: red;"
            self.username_error.setStyleSheet(username_error_stylesheet)
            return
            ...
            password_error_stylesheet = "font-size: 20px; color: red;"
            self.password_error.setStyleSheet(password_error_stylesheet)
            return
        elif len(password) < 8:
